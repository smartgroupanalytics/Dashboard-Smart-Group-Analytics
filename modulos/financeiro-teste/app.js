...
const mapaPermissoes = {
    ...
    "financeiro-teste": "financeiro-teste",
    compras: "compras",
...
break;
            ...
            case "financeiro-teste":

    titulo.innerText = "Financeiro Teste";
    ...
    conteudo.innerHTML = `
        <iframe
            src="modulos/financeiro-teste/index.html?v=1"
            class="iframe-modulo"
            title="Módulo Financeiro - Ambiente de Teste"
            frameborder="0">
        </iframe>
    `;
...
function gerarCardsDashboardPermitidos() {
    ...
    const cards = [
        ...
        {
            modulo: "financeiro-teste",
            icone: "fa-solid fa-flask",
            titulo: "Financeiro Teste",
            descricao:
                "Ambiente isolado para testar alterações sem afetar o Financeiro em uso."
        },
        {
            modulo: "compras",
...
const modulosBusca = [
    ...
    },
    {
        ...
        descricao: "Ambiente isolado de desenvolvimento do módulo financeiro",
        modulo: "financeiro-teste"
    },
    {
